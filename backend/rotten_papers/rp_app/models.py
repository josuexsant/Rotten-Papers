...
class Users(models.Model):
    ...
    class Meta:
        db_table = 'users'  # Asegúrate de que coincida con el nombre de la tabla en MySQL
...
class Authors(models.Model):
    ...
    lastname1 = models.CharField(max_length=250, blank=True, null=True)
    lastname2 = models.CharField(max_length=250, blank=True, null=True)
...
class Books(models.Model):
    ...
    rating = models.FloatField()  # Cambiado a FloatField para coincidir con FLOAT(53) en MySQL

    def __str__(self):
        return f"Title: {self.title}, Synopsis: {self.synopsis}, Genre: {self.genre_id}"
